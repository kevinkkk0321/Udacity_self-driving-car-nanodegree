...
int main() {
  ...
  h.onMessage([&ref_vel, &map_waypoints_x,&map_waypoints_y,&map_waypoints_s,
               &map_waypoints_dx,&map_waypoints_dy, &lane, &MAX_ACC, &MAX_SPEED]
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
           ...
           */
            ...
            // Get some previous path from the car
            if (prev_size < 2) {
            ...
            // Add previous path from the previous path which are not yet finished to the future path list
            ...
            // Fill up the previous path points, add on the points from splime
